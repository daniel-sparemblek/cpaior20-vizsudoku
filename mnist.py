...
def main():
    ...
    parser.add_argument('--save-every', action='store_true', help='enable this to save model at each epoch', default=False)

    parser.add_argument('--save-epoch-progress', action='store_true', default=False, 
